...
<body>
	<div id="Wrapper">
		...
		mysql_query("INSERT INTO user(name,gender,blood,blood_2,birth_y,birth_m,birth_d,idnumber,address,pro,phone,email) VALUES ('$name','$gender','$blood','$blood_2','$birth_y','$birth_m','$birth_d','$idnumber','$address','$pro','$phone','$email')");
...
<center><font  face="微軟黑正體" color="#01814A">確認完畢，回上頁</font></center>
